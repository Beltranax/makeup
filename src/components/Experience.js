        ...
        <div className="my-64">
            ...
            <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
                ...
                <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
                    ...
                    work="orked on a team responsible for developing a new mobile app feature that allowed users to create and 
                    ...
                    <Details 
                    position = "Teaching Assistant" company="MIT"
                    companyLink="www.google.com"
                    time="Fall 2018" address="Massachusetts Ave, Cambridge, MA"
                    work="ssisted in teaching a course on computer programming, held office hours to help students with assignments, 
