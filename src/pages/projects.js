...
const FeaturedProject = ({type, title, summary, img, link, github}) => {
    return(
        ...
        ">
            ...
            <Link href={link} 
            target="_blank"
            className="w-1/2 cursor-ponter overflow-hidden rounded-lg lg:w-full">
            ...
            <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
                ...
                <div className="mt-2 flex items-center">
                    ...
                    p-2 px-6 text-lg font-semibold dark:bg-light dark:text-dark sm:px-4 sm:text-base">Visit Projects</Link>
                </div>
            </div>
        </article>
    )
...
const Project = ({title, type, img, link, github}) => {
    ...
    return(
        ...
        border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light xs:p-4">
            ...
            className="w-full cursor-ponter overflow-hidden rounded-lg">
                <FramerImage src={img} alt={title} className="w-full h-auto" 
                whileHover={{scale:1.05}}
                transition={{duration:0.2}}
                />
...
const projects = () => {
    return (
        <>
            <Head>
                <title> Enyel | Projects Page </title>
                <meta name="projects" content="any projects" />
            </Head>
            <TransitionEffect />
